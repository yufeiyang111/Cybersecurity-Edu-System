...
class AgentRun(db.Model):
    ...
    iteration_count = db.Column(db.Integer, nullable=False, default=0)
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "max_estimated_cost": float(self.max_estimated_cost) if self.max_estimated_cost is not None else None,
            "max_wall_clock_seconds": self.max_wall_clock_seconds,
            "max_deep_review_files": self.max_deep_review_files,
...
class AgentToolCall(db.Model):
    ...
    provider_call_id = db.Column(db.String(128))
    logical_call_key = db.Column(db.String(255))
    attempt_number = db.Column(db.Integer, nullable=False, default=1)
    arguments_digest = db.Column(db.String(64))
    result_schema_version = db.Column(db.Integer)
...
class AgentCheckpoint(db.Model):
    ...
    current_item_public_id = db.Column(db.String(64))
    lease_owner = db.Column(db.String(255))
    checkpoint_digest = db.Column(db.String(64))
    created_at = db.Column(db.DateTime, nullable=False, default=datetime.utcnow)
