...
class Config:
    ...
    # T12/T15：Agent 协议与 Harness V3 开关（默认关闭，按 workspace/全局灰度）。
    AGENT_LOOP_V2_ENABLED = _env_bool("AGENT_LOOP_V2_ENABLED", False)
    AGENT_EVENT_SCHEMA_V2_ENABLED = _env_bool("AGENT_EVENT_SCHEMA_V2_ENABLED", False)
    AGENT_TIMELINE_V2_ENABLED = _env_bool("AGENT_TIMELINE_V2_ENABLED", False)
    AGENT_HARNESS_V3_ENABLED = _env_bool("AGENT_HARNESS_V3_ENABLED", False)
