...
const form = reactive({ name: '', base_url: '', model: '', api_key: '', is_enabled: true, is_default: false })

watch(() => props.provider, (provider) => {
  Object.assign(form, provider ? { name: provider.name, base_url: provider.base_url, model: provider.model, api_key: '', is_enabled: provider.is_enabled, is_default: provider.is_default } : { name: '', base_url: '', model: '', api_key: '', is_enabled: true, is_default: false })
}, { immediate: true })
const reset = () => { Object.assign(form, { name: '', base_url: '', model: '', api_key: '', is_enabled: true, is_default: false }) }
