  ...
  <main class="llm-page">
    <header class="page-header">
      ...
      <div class="actions">
        ...
        <BaseButton variant="primary" @click="search">
    ...
    <BasePanel class="table-panel">
      <template #default>
        <LlmCallLogTable :logs="logs" :loading="loading" />
      </template>
      <template #footer>
        <LlmLogPagination
...
.table-panel :deep(.ui-panel__body) {
  padding: 0;
}

.table-panel :deep(.ui-panel__footer) {
  padding: 0 12px;
}
